...
(custom-set-variables
 ...
 '(package-selected-packages
   '(flycheck lua-mode adaptive-wrap visual-fill-column utop merlin nix-mode tuareg haskell-mode hasklig-mode racket-mode company htmlize forge presentation-mode org-present org poly-org paredit ess quarto-mode request poly-markdown polymode magit color-theme-sanityinc-solarized use-package))
